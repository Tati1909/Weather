...
class MainRepositoryImpl : MainRepository {
    ...
    override fun getWeatherFromLocalStorageRus(): List<Weather> = listOf(
    ...
    override fun getWeatherFromLocalStorageWorld(): List<Weather> = listOf(
        ...
        Weather(City("Ивашки", 52.707939, 25.335199), 11, 12),
